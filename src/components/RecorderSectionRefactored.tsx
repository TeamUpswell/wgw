// Components/RecorderSectionRefactored.tsx
...
interface RecorderSectionRefactoredProps {
  ...
  onCameraPress?: () => void;
  isAddingAdditionalEntry?: boolean;
  onPrivacyChange?: (isPrivate: boolean) => void;
  initialPrivacy?: boolean;
}

export const RecorderSectionRefactored: React.FC<RecorderSectionRefactoredProps> = ({
  selectedCategory,
  onRecordingComplete,
  categories,
  onCategorySelect,
  ...
  const isProcessing = isLoading('recording');
