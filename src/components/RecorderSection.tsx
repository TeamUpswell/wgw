    ...
    <View style={styles.recorderContainer}>
      ...
      >
        <TouchableOpacity
          style={[
            styles.recordButton,
            isProcessing && { opacity: 0.4 }, // Dim when disabled
          ]}
        ...
        >
          <Ionicons
            ...
            size={70}
            color={isProcessing ? "#bbb" : "#fff"} // Change color when disabled
          />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          style={[
            styles.recordButton,
            { marginLeft: 20, backgroundColor: "#FF6B35" },
